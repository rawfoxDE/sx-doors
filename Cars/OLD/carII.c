...
keypress:
        PS("\033[2J");
	XIMFunction(8,0,"car_mainmenu.ans");
...
void Race(int carflag)
{
        ...
        PS("\033[2J");                                            
        XIMFunction(8,0,"car_race.ans");    //   gfx
...
void Selection(int carflag)
{
       ...
       // int carflag;   
        ...
        XIMFunction(8,0,"car_selection.ans");    //   gfx
...
{       
        ...
        fhpl = Open("car_log", MODE_OLDFILE);
        if(fhpl==NULL) 
        {
                fhpl = Open("car_log", MODE_NEWFILE);
...
void topten(void)
{
    ...
    char buf[256],oldname[32];
        ...
        PS("\033[2J");
        XIMFunction(8,0,"car_topten.ans");
        PS("[0;0H");
        PS("[6B");
        //oldname=="EMPTY";
        ...
        {                        
                ...
                while(Read(fhpl, &Player, sizeof(struct PlayerStruct)))
                {
                        ...
                        sprintf(buf,"\r[2B[5C%-12s[18C%6ld[5C%9s",Player.name,Player.races,Player.laston);   
                        PS(buf);
